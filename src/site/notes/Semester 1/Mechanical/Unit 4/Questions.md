...
***
[[Semester 1/Mechanical/Unit 4/Core Notes\|Core Notes]] | [[Examples\|Examples]] | [[Semester 1/Mechanical/Unit 4/Questions\|Questions]]
***
...
*   **Answer**: A **three-jaw (self-centering) chuck** is most efficient. All jaws move simultaneously, automatically centering round/symmetrical jobs. See [[Semester 1/Mechanical/Unit 4/Core Notes#23-work-holding-devices-chucks\|Core Notes.md]] and [[Examples#example-2:-efficient-chuck-for-cylindrical-part\|Examples.md]].
...
*   **Answer**: High-velocity abrasive particle jet causes tiny brittle fractures. Advantages: suitable for brittle/hard materials, intricate shapes, no direct contact, low heat. Limitations: low MRR, not for ductile materials. See [[Semester 1/Mechanical/Unit 4/Core Notes#32-abrasive-jet-machining-ajm\|Core Notes.md]] and [[Examples#example-3:-non-conventional-machining-for-ceramic-holes\|Examples.md]].
