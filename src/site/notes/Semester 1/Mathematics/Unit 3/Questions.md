...
*   **1. Form the PDE from $z = y^2 + 2f(1/x + \log y)$.**
    *   **Answer**: $x^2 p + yq = 2y^2$. See [Examples](Examples.md#Example%202:%20Formation%20by%20Eliminating%20Arbitrary%20Functions).
...
*   **6. Solve $2yzp + zxq = 3xy$.**
    *   **Answer**: $\phi(x^2 - 2y^2, 3y^2 - z^2) = 0$. See [Examples](Examples.md#Example%203:%20Lagrange's%20Method%20-%20Grouping).
...
*   **10. Solve $x^2 \frac{\partial u}{\partial x} + y^2 \frac{\partial u}{\partial y} = 0$.**
    *   **Answer**: $u = c e^{k(1/x - 1/y)}$. See [Examples](Examples.md#Example%206:%20Separation%20of%20Variables%20-%20Heat%20Eq).
...
*   **13. Solve $(D^2 + DD' - 2D'^2)z = 5e^{x+2y}$.**
    *   **Answer**: $z = \phi_1(x+y) + \phi_2(2x-y) - e^{x+2y}$. See [Examples](Examples.md#Example%205:%20Higher%20Order%20PDE%20Solution).
